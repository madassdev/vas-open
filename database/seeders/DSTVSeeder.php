...
class DSTVSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $dstv->subProducts()->create([
            'name' => 'REMIUM + FRENCH PLUS ADD ON - 25550',
            'price' => 25550,
        ...
        $dstv->subProducts()->create([
            'name' => 'REMIUM + FRENCH TOUCH ADD ON - 20700',
            'price' => 20700,
        ...
        $dstv->subProducts()->create([
            'name' => 'PREMIUM + FRENCH + XTRAVIEW - 32000	',
            'price' => 32000,
        ...
        $dstv->subProducts()->create([
            'name' => 'COMPACT PLUS + ASIA + XTRAVIEW- 24250',
            'price' => 24250,
        ...
        $dstv->subProducts()->create([
            'name' => 'COMPACT PLUS + FRENCH PLUS + XTRAVIEW - 26450',
            'price' => 26450,
        ...
        $dstv->subProducts()->create([
            'name' => 'COMPACT + FRENCH + XTRAVIEW - 14550',
            'price' => 14550,
        ...
        $dstv->subProducts()->create([
            'name' => 'COMPACT + ASIA + XTRAVIEW - 19000',
            'price' => 19000,
        ...
        $dstv->subProducts()->create([
            'name' => 'HDPVR ACCESS SERVICE E36 - 2900',
            'price' => 2900,
