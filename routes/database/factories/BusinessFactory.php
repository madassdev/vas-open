...
class BusinessFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'test_api_key' => 'pk_test_' . $this->faker->uuid(),
            'live_api_key' => 'pk_live_' . $this->faker->uuid(),
            'test_secret_key' => 'sk_test_' . $this->faker->uuid(),
            'live_secret_key' => 'sk_live_' . $this->faker->uuid(),
